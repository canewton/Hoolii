...
class AvatarConstants {
    ...
    static let hairOption1 = FacialFeatureOption.instanceFromNib().addHair(front: UIImage(named: "Female hair 1 front"), back: UIImage(named: "Female hair 1 back"), hairShift: 0.1)
    ...
    static let hairOption7 = FacialFeatureOption.instanceFromNib().addHair(front: nil, back: UIImage(named: "Female hair 7"), hairShift: -0.07)
    ...
    static let hairOption10 = FacialFeatureOption.instanceFromNib().addHair(UIImage(named: "Female hair 10"), hairShift: 0.1)
    ...
    static let hairOption15 = FacialFeatureOption.instanceFromNib().addHair(UIImage(named: "Female hair 15"), hairShift: -0.05)
    ...
    static let hairOption22 = FacialFeatureOption.instanceFromNib().addHair(front: UIImage(named: "Male hair 7 front"), midFront: UIImage(named: "Male hair 7 side"), midBack: nil, back: nil, hairShift: -0.1)
